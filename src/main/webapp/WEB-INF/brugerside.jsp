                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted card-subtitle mb-2">Her kan du se dit nuværende Carport projekt</h6><button class="btn btn-primary" type="button" onclick="window.location.href = 'bygcarport.jsp';" style="margin-top: 10px;">Klik her</button></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card">
